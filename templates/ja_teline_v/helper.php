...
JLoader::register('JATemplateHelperContent', dirname(__FILE__) . '/helper.content.php');
...
class JATemplateHelper
{
	...
	public static function getParams () {
		...
		if (!$menuParams) {
			...
			{
				$menuParams->loadString(version_compare(JVERSION,'4','ge') ? $menu->getParams() : $menu->params );
			}
