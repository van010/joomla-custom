		...
		if((int) $aparams->get('show_latest_article')) {
			...
			if($article) {
				if(version_compare(JVERSION, '4', 'ge')){
					if(!class_exists('JAContentModelArticle')){
						class JAContentModelArticle extends \Joomla\Component\Content\Site\Model\ArticleModel{};
					}
					$model = new JAContentModelArticle(array());
