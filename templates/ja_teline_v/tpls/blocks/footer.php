...
<footer id="t3-footer" class="wrap t3-footer">
  ...
  <section class="t3-copyright">
  	<div class="row">
        ...
        <small>Copyright &copy; <?php echo date("Y"); ?> Joomla!. All Rights Reserved. Powered by <a href="<?php echo JURI::base(true) ?>" title="<?php echo strip_tags($sitename) ?>" rel="nofollow"><?php echo strip_tags($sitename) ?></a> - Designed by JoomlArt.com.</small>
        <small>
