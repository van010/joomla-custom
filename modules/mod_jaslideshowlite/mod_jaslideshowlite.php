...
if( !empty($list) ) :
	...
	require( $layout );
?>
<script type="text/javascript" src="<?php echo JURI::root(true). '/modules/' . $module->module . '/assets/js/script.js';?>"></script>
<script type="text/javascript">
	window.addEventListener('DOMContentLoaded', function(){
		window.jassliteInst = window.jassliteInst || {};
		window.jassliteInst['ja-ss-<?php echo $module->id;?>'] = new JASliderCSS('#ja-ss-<?php echo $module->id;?>', {
			interval: 5000,
		...
		jQuery(document).ready(function($){
			window.jassliteInst['ja-ss-<?php echo $module->id;?>'].initialize();
		});
	});
</script>
<!-- Fix animation in IE -->
